import { Bell, Github, Lock, Save, Trash2, User } from 'lucide-react'
    ...
    <div className="page">
      ...
      <div className="settings-grid">
        ...
        <section className="card form-card">
          ...
          {active === 'integrations' && <><h2>Connected Accounts</h2><div className="integration-row"><span><Github size={28} /> <span><strong>GitHub</strong><small>Connected as @aniketsingh</small></span></span><button className="btn btn-secondary">Disconnect</button></div><p className="muted">GitHub lets contributors link repositories to notes and showcase real work.</p></>}
        </section>
      </div>
    </div>
  )
